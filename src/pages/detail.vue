  ...
  <div class="detail-wrap">
    <div class="detail-left">
      <div class="product-board">
          <img :src="productIcon">
        <ul>
            <router-link v-for="item in product" :to={name:item.path} tag="li" active-class="active">
              {{item.name}}
            </router-link>
        </ul>
      </div>
...
export default{
    ...
    computed:{
        productIcon(){
            return this.imgMap[this.$route.path]//this.$route.path取的route的path:'/detail/count' 全局都能获取
        }
    }
}
</script>
